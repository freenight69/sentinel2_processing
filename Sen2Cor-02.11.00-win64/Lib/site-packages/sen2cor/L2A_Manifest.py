...
class L2A_Manifest():
    def __init__(self, config):
        ...
        if config.namingConvention == 'SAFE_STANDARD': 
            ...
            # fix for SIIMPC-734 VD:
                "DefectivePixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_DEFECT_.*.jp2", # discard .gfs .gml
                "DetectorFootprintMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_DETFOO_.*.jp2", # discard .gfs .gml
                "NodataPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_NODATA_.*.jp2", # discard .gfs .gml
                "SaturatedPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_SATURA_.*.jp2", # discard .gfs .gml
                "TechQualityMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_TECQUA_.*.jp2", # discard .gfs .gml
                "QualitPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "S2[AB]_OPER_MSK_QUALIT_.*.jp2",# discard .gfs .gml
            ...
            # GRANULE/AUX_DATA -->
                "CAMS_Tile1":"S2[AB]_OPER_AUX_CAMS*",
                "ECMWF_Tile1":"S2[AB]_OPER_AUX_ECMWF_*",
            ...
            # GRANULE/QI_DATA -->
                ...
                "Format_OLQC_Report_Tile([1-9]?[0-9]{1,4})_InformationData": "S2[AB]_OPER_MSI_L2A_TL_.*FORMAT_CORRECTNESS",
            # fix for SIIMPC-734 VD:
                "DefectivePixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_DEFECT_.*.jp2", # discard .gfs .gml
                "DetectorFootprintMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_DETFOO_.*.jp2", # discard .gfs .gml
                "NodataPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_NODATA_.*.jp2", # discard .gfs .gml
                "SaturatedPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_SATURA_.*.jp2", # discard .gfs .gml
                "TechQualityMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_TECQUA_.*.jp2", # discard .gfs .gml
                "QualitPixelsMask_Band([1-9]|1[0-3])_Tile([1-9]?[0-9]{1,6})_Data": "MSK_QUALIT_.*.jp2",# discard .gfs .gml
            # end fix for SIIMPC-734
    ...
    def getMimeType(self, href):
        ...
        try:
            output_mime_type = dicoMimeType[href.split(".")[-1]]
        except:
