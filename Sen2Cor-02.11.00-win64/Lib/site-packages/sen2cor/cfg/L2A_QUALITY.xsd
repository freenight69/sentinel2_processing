...
<xs:schema xmlns="http://gs2.esa.int/DATA_STRUCTURE/l2aqiReport" xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="http://gs2.esa.int/DATA_STRUCTURE/l2aqiReport" elementFormDefault="qualified" attributeFormDefault="unqualified" version="14">
				...
				<xs:complexType>
					<xs:sequence>
						...
						<xs:element name="Mission">
							<xs:annotation>
								<xs:documentation>Fixed string : Mission ID extracted from filename (MMM = "S2_"|"S2A"|"S2B")</xs:documentation>
							</xs:annotation>
							<xs:simpleType>
								<xs:restriction base="xs:string">
