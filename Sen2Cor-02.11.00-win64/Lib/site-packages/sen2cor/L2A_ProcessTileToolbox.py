...
class L2A_ProcessTile(object):
    ...
    def _process(self):
        ...
        if self.config.resolution > 10:
            ...
            if self.config.test_roi_scene == True:
                self.config.timestamp('L2A_ProcessTile: [Warning] The ROI=AUTO processing is still experimental with the last evolution of Scene Classification module')
